...
// validation is applied for checking 
//1. designation is correct
//2. PAN number should not exists
...
pw.println("</body>");
pw.println("</html>");
return;   // add form resent because of problems (validation error)
}
...
pw.println("<tr>");
pw.println("<td>");
pw.println("<form action='/styleone/getEmloyeeAddForm'>");
